...
<body>
    <form id="_formMain" runat="server">
        <div style="margin:auto;width:50%;text-align:center;">
			...
			<asp:Panel ID="_pnlSuccess" runat="server" Visible="true">
				...
				<table style="font-family:Verdana;width:75%;border-radius: 30px 30px 30px 30px;border: 1px solid #bde76b;background: linear-gradient(0deg,#bde76b 0,#FFFFFF);">
					...
					<tr>
						...
						<td style="vertical-align:central;font-weight:bold;text-align:left;">
							The <asp:Label ID="_lblSuccesssType" runat="server"></asp:Label>&nbsp;<asp:Label ID="_lblSuccessValue" runat="server"></asp:Label> you chose is AVAILABLE!
						</td>
					</tr>
					<tr>
						<td colspan="2">&nbsp;</td>
					...
					<tr>
						<td colspan="2" style="text-align:center;align-content:center">
							<div title="Click here to continue" style="cursor:pointer;margin:auto;width:50%;width:200px;border-radius: 30px 30px 30px 30px;border: 2px solid #808080;background-color:#f2e9e9;color:#000000;font-weight:bold;">
								Continue
							</div>
						</td>
					</tr>
			...
			<asp:Panel ID="_pnlFailure" runat="server" Visible="true">
				<div style="text-align:center">
				<table style="font-family:Verdana;width:75%;border-radius: 30px 30px 30px 30px;border: 1px solid red;background: linear-gradient(90deg,#FFFFFF 0,#ed5959);">
					...
					<tr>
						...
						<td style="vertical-align:central;font-weight:bold;text-align:left;">
							The <asp:Label ID="_lblFailureType" runat="server"></asp:Label>&nbsp;<asp:Label ID="_lblFailureValue" runat="server"></asp:Label> you chose is NOT AVAILABLE!
						</td>
					</tr>
					<tr>
						<td colspan="2">&nbsp;</td>
					...
					<tr>
						<td colspan="2">
							<div title="Click here to go back & change" style="cursor:pointer;margin:auto;width:50%;width:200px;border-radius: 30px 30px 30px 30px;border: 2px solid #808080;background-color:#f2e9e9;color:#000000;font-weight:bold;">
								Go Back & Change
							</div>
						</td>
					</tr>
